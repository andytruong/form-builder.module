...
class FormUIController extends EntityDefaultUIController {
  ...
  public function hook_menu() {
    ...
    $items['admin/structure/fob-form/manage/%entity_object']['page callback'] = $items['admin/structure/fob-form/add']['page callback'] = 'Drupal\form_builder\Controller\EntityEditController::pageCallback';
