<div ng-if="itemInfo.editing">
  <div class="form-item fomr-type-textfield">
    <input type="text"
           ...
           ng-model="entity.layoutOptions.pages[pageId].groups[itemInfo.uuid].title"
           ng-model-options="{ updateOn: 'blur' }"/>
  </div>

  <div class="form-item form-type-select">
    <label for="edit-language">Group type</label>
    <select class="form-select" ng-model="entity.layoutOptions.pages[pageId].groups[itemInfo.uuid].type">
  ...
  <div class="group-options" ng-if="'fieldset' === itemInfo.type">
    <div class="form-item form-type-checkbox form-item-collapsible">
      <input type="checkbox"
             id="edit-collapsible-{{itemInfo.uuid}}"
             class="form-checkbox"
             ng-model="entity.layoutOptions.pages[pageId].groups[itemInfo.uuid].options.collapsible" />
    ...
    <div class="form-item form-type-checkbox form-item-collapsed">
      <input type="checkbox"
             id="edit-collapsed-{{itemInfo.uuid}}"
             class="form-checkbox"
             ng-model="entity.layoutOptions.pages[pageId].groups[itemInfo.uuid].options.collapsed" />
